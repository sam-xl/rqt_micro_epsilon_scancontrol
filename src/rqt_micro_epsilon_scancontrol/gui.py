...
class ScanControlGui(Plugin):
    ...
    def __init__(self, context):
        ...
        ui_file = os.path.join(rospkg.RosPack().get_path('rqt_micro_epsilon_scancontrol'), 'resource', 'me_scancontrol_gui.ui')
...
class ScanControlManualSettingsGui(Plugin):
    ...
    def __init__(self, context):
        ...
        # Create QWidget
        self._widget = QWidget()
        ui_file = os.path.join(rospkg.RosPack().get_path('rqt_micro_epsilon_scancontrol'), 'resource', 'me_scancontrol_gui_manual_settings.ui')
